...
part 'split_circular_percent_painter.dart';

// ignore: must_be_immutable
class SplitCircularPercentIndicator extends StatefulWidget {
  ...
  @override
  _SplitCircularPercentIndicatorState createState() =>
      _SplitCircularPercentIndicatorState();
}

class _SplitCircularPercentIndicatorState
    extends State<SplitCircularPercentIndicator>
  ...
  void _checkIfNeedCancelAnimation(SplitCircularPercentIndicator oldWidget) {
  ...
  @override
  void didUpdateWidget(SplitCircularPercentIndicator oldWidget) {
            ...
            Transform.rotate(
              ...
              child: CustomPaint(
                painter: _CirclePainter(
                    ...
                    totalDivider: widget.totalDivider,
                    spacing: widget.spacing),
                child: Transform.rotate(angle: pi/2, child: (widget.center != null)
